...
public class act_buy_browse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(act_buy_browse.this, "Nothing Selected", Toast.LENGTH_SHORT).show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                alert_confirm.setMessage("Do you confirm to purchase the following:" + " \n" + "\n Product :"+cltemSelected_Pname+"  "+"\nQuantity :"+cltemSelected_Pqty+"\n"+"Price: "+cltemSelected_Pprice);
                alert_confirm.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent = new Intent(act_buy_browse.this, act_buy_editrecords.class);
                        intent.putExtra(act_buy_editrecords.CFNAME, cfname);
                        intent.putExtra(act_buy_editrecords.CLNAME, clname);
                        intent.putExtra(act_buy_editrecords.PQTY, pqty);
                        intent.putExtra(act_buy_editrecords.PNAME, pname);
                        intent.putExtra(act_buy_editrecords.PPRICE, pprice);
                        intent.putExtra(act_buy_editrecords.CCONTACT, ccontact);
                        intent.putExtra(act_buy_editrecords.BBNAME, bbuyername);
                        intent.putExtra(act_buy_editrecords.BBQTY, bbuyerqty);
                        intent.putExtra(act_buy_editrecords.BBCONTACT, bbuyercontact);
                        intent.putExtra(act_buy_editrecords.ID, aydi);
    ...
    private class uploadDataToURL extends AsyncTask<String, String, String> {
        ...
        int nPostValueIndex;
        ProgressDialog pDialog = new ProgressDialog(act_buy_browse.this);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            String isEmpty = "";
            android.app.AlertDialog.Builder alert = new AlertDialog.Builder(act_buy_browse.this);
            if (s != null) {
                ...
                adapter_Pname = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class CLNAME extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String CLNAME) {
            ...
            if (CLNAME != null) {
                ...
                adapter_clname = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class PQTY extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String PQTY) {
            ...
            if (PQTY != null) {
                ...
                adapter_pqty = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class CFNAME extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String CFNAME) {
            ...
            if (CFNAME != null) {
                ...
                adapter_cfname = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class PPRICE extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String PPRICE) {
            ...
            if (PPRICE != null) {
                ...
                adapter_Pprice = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class BUYERNAME extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String BUYERNAME) {
            ...
            if (BUYERNAME != null) {
                ...
                adapter_Buyername = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class BUYERQTY extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String BUYERQTY) {
            ...
            if (BUYERQTY != null) {
                ...
                adapter_Buyerqty = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class BUYERCONTACT extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String BUYERCONTACT) {
            ...
            if (BUYERCONTACT != null) {
                ...
                adapter_Buyercontact = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class CCONTACT extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String CCONTACT) {
            ...
            if (CCONTACT != null) {
                ...
                adapter_Ccontact = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class id extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String aydi) {
            ...
            if (aydi != null) {
                ...
                Toast.makeText(act_buy_browse.this, "Data selected", Toast.LENGTH_SHORT).show();
                ...
                adapter_ID = new ArrayAdapter<String>(act_buy_browse.this,
    ...
    private class delete extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String del) {
            ...
            if (aydi != null) {
                ...
                Toast.makeText(act_buy_browse.this, "Data Deleted", Toast.LENGTH_SHORT).show();
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet connection");
                alert.setTitle("Error");
                alert.show();
